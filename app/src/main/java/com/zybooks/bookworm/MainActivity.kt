...
val sampleBooks = mutableListOf(
    ...
    Book(id = 5, title = "The Hobbit", author = "J.R.R. Tolkien", imageUrl = "https://m.media-amazon.com/images/I/712cDO7d73L._SY522_.jpg", userRating = 2.0f, dateAdded = "2024-10-06", review = "An adventurous journey through Middle Earth.", totalPages = 310, pagesRead = 45, genre = "Fantasy\n" +
